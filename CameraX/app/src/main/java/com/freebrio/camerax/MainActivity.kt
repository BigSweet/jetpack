...
class MainActivity : AppCompatActivity() {
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            setPreviewExtender(build, cameraSelector)
    ...
    private class LuminosityAnalyzer(val listener: ((Double) -> Unit)? = null) : ImageAnalysis.Analyzer {
